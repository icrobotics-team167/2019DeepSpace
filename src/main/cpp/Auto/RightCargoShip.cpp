...
/**
 * Initializes the right cargo ship auto routine
 * 
 ...
 */ 
RightCargoShip::RightCargoShip(DriveBase *driveBase, Claw *claw, Elevator *elevator, Bling *bling, Cargo *cargo, GenericController* controller, Teleop *teleop):
...
/**
 * Scores on the front right cargo ship, picks up a hatch from the riught
 * human player station, and scores on the side right cargo ship
 * 
 * @author Dominic Rutkowski
 * @since 2-10-2019
 */ 
